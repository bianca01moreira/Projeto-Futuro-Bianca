        ...
        <div style={{ display: "flex", minHeight: "calc(100vh - 150px)" }}>
            ...
            >
                {!readOnly ? (
                    ...
                    <div>
                        <div style={{ background: '#fff', color:"black", padding: 12, borderRadius: 6, wordBreak: 'break-word', overflowWrap: 'break-word' }} dangerouslySetInnerHTML={{ __html: conteudoCurso || '<p>Sem conteúdo</p>' }} />
